...
plt.title ("Radius (cs82) at average ZBAND per redshift bin (redMaGiC) \nvs Stellar Mass (MGC) predicted using linear emcee fit" % centralzband)
plt.ylabel("Predicted Radius (kpc)")
